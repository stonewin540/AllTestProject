...
@interface SubTopicTableView ()

@end

@implementation SubTopicTableView
...
//    for (int i = 0; i < 10; i++)
//    {
//        NSString *stringObject = [NSString stringWithFormat:@"Row%d", i];
//        [self.dataArray addObject:stringObject];
//    }
}
